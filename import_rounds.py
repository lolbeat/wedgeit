...
##use XPATH to search for state = Selangor (the ... means findall will return ALL the attributes and not only state)
#for course in root.findall(".//Course/[@S='Selangor']"):
    #print (course.attrib)

#for tee in root.findall(".//*[@N='Kelab Golf Seri Selangor Old']/Tees/Tee"):
    #print (tee.attrib)
